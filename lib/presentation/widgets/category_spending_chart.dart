...
class CategorySpendingChart extends StatefulWidget {
  const CategorySpendingChart({super.key, required this.categories});
      ...
      child: Column(
        ...
        children: [
          for (final entry in visibleCategories) ...[
            _CategoryBar(entry: entry, totalExpenses: totalExpenses),
...
class _CategoryBar extends StatelessWidget {
  const _CategoryBar({required this.entry, required this.totalExpenses});
